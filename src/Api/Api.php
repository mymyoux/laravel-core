        ...
        foreach($folders as $folder)
        {
            ...
            foreach ($files as $file)
            {
                ...
                try{
                    ...
                    $class_data = ClassHelper::getInformations($file, True);
                }catch(\Exception $e)
                {
                    //ignore
                    continue;
               ...
               }catch(\Exception $e)
               {
                ...
                if(!empty($classAnnotations) || !empty($methodAnnotations))
                {
                    ...
                    foreach($methodAnnotations as $methodName=>$annotations)
                    {
                        ...
                        //handle param substitute binding
                        $route->middleware('Core\Http\Middleware\Api\Params');
                    }
                }
            }
        }
